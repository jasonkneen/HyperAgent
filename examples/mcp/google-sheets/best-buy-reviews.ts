 ...
 * 3. Creates a new spreadsheet titled "BestBuy Reviews"
 * 4. Navigates to BestBuy to gather data on the reviews for the MacBook Air M2
 ...
 * and populated it with information about the reviews for the MacBook Air M2.
 */
...
4. Create a new spreadsheet titled "BestBuy Reviews".
5. Go to https://www.bestbuy.com/site/apple-macbook-air-13-inch-apple-m2-chip-built-for-apple-intelligence-16gb-memory-256gb-ssd-midnight/6602763.p?skuId=6602763 .
6. Scroll down until you see the "See All Customer Reviews" button and click on the button.
7. Once on the next page, get all the reviews from the first page.
8. Add the reviews to the "BestBuy Reviews" spreadsheet. Include these columns and data for all the columns: Review Title, Rating, Review Text, Verified Purchase, and Review Date.
Make sure that the data is well formatted and the columns are all there, make sure to not cut off any of the full review text, please include it all and to get all the reviews.`;
